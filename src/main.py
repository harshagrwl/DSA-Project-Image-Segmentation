...
print("After entering the file name, press 'O' to mark the objects and 'B' to mark the background with the Left Mouse Button. Press 'Esc' when done.")
print("WARNING: High resolution images take a very long time, use smaller images (test.jpg is 628x472 = 2,96,416 pixels).")
...
plt.subplot(1, 3, 2)
plt.imshow(sp_lab)
plt.xlabel("Image After Pixels Have Been Grouped")
